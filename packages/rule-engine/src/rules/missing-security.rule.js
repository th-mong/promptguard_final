...
exports.MissingSecurityRule = void 0;
...
const RULE_DATA = {
    ...
    rewriteTemplate: '인증, 권한 검사, 입력값 검증 조건을 포함하여 기능을 요청하세요. ' +
        '예: "사용자 인증과 파일 형식 검증이 포함된 안전한 업로드 기능을 만들어줘"',
    version: 1,
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
};
class MissingSecurityRule extends base_rule_1.BaseRule {
    constructor() {
        super(RULE_DATA);
    }
}
exports.MissingSecurityRule = MissingSecurityRule;
