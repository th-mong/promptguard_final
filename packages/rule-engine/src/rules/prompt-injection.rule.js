...
const RULE_DATA = {
    ...
    reasonTemplate: 'AI 시스템을 우회하려는 프롬프트 인젝션 시도가 감지되었습니다.',
    rewriteTemplate: 'AI의 기본 정책을 준수하는 범위 안에서 원하는 내용을 요청하세요.',
    version: 1,
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
};
class PromptInjectionRule extends base_rule_1.BaseRule {
    constructor() {
        super(RULE_DATA);
    }
}
