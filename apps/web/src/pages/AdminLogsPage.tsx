...
export default function AdminLogsPage() {
  ...
  const getTypeBadgeStyle = (type: string): React.CSSProperties => {
    ...
    switch (type) {
      case "rule_create":
        return { ...base, backgroundColor: "#1a3a1a", color: "#4ade80" };
      case "rule_update":
        return { ...base, backgroundColor: "#1a2a3a", color: "#60a5fa" };
      case "rule_disable":
        return { ...base, backgroundColor: "#3a1a1a", color: "#f87171" };
      case "analyze":
        return { ...base, backgroundColor: "#2a2a1a", color: "#facc15" };
      default:
        return { ...base, backgroundColor: "#2a2a2a", color: "#9ca3af" };
    }
  };
      ...
      <main className="dashboard-content">
        ...
        <section className="large-card">
          <div style={styles.filterBar}>
            <button
              style={filter === "" ? styles.filterBtnActive : styles.filterBtn}
              onClick={() => setFilter("")}
            >
              전체
            </button>
            ...
            <button
              ...
              onClick={() => setFilter("rule_disable")}
            >
              룰 삭제
            </button>
            <button
              style={
                filter === "analyze" ? styles.filterBtnActive : styles.filterBtn
              }
                ...
                {logs.map((log) => (
                  <tr key={log.id}>
                    ...
                    <td style={{ ...styles.td, width: "100px" }}>
                      <span style={getTypeBadgeStyle(log.type)}>
